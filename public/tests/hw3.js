...
describe('color', function() {
  it('should return "red" when the ID is 0', function() {
    assert.equal(color(0), 'red');
  });
  it('should return "black" when the ID is 2', function() {
    assert.equal(color(2), 'black');
  });
  it('should return NaN when the ID is "apple"', function() {
    assert.equal(isNaN(color("apple")), true);
  });
  it('should return NaN when the ID is true', function() {
    assert.equal(isNaN(color(true)), true);
  });
  it('should return NaN when the ID is false', function() {
...
describe('name', function() {
  ...
  it('should return NaN when the cardID is -1', function() {
    assert.equal(isNaN(name(-1)), true);
  });
  it('should return NaN when the cardID is 52', function() {
    assert.equal(isNaN(name(52)), true);
  });
  it('should return NaN when the cardID is NaN', function() {
